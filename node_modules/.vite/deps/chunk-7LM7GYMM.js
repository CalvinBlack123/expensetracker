...
var handleOAuthSignOut = async (cognitoConfig, store, tokenOrchestrator2) => {
...
async function signOut(input) {
  ...
  if (hasOAuthConfig) {
    ...
    const { type } = await handleOAuthSignOut(cognitoConfig, oAuthStore2, tokenOrchestrator) ?? {};
    if (type === "error") {
      throw new AuthError({
...
//# sourceMappingURL=chunk-7LM7GYMM.js.map
