...
declare const PutAccountPolicyCommand_base: {
    new (input: PutAccountPolicyCommandInput): import("@smithy/smithy-client").CommandImpl<PutAccountPolicyCommandInput, PutAccountPolicyCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutAccountPolicyCommandInput): import("@smithy/smithy-client").CommandImpl<PutAccountPolicyCommandInput, PutAccountPolicyCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
